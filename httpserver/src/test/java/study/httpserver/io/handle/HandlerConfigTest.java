package study.httpserver.io.handle;
...
public class HandlerConfigTest {
	...
	public void testAddHandlerWithError() {
		...
		thrown.expectMessage(new IsEqual<String>("Http handler already exists for url=/test. Http handler class: "
				+ httpHandlerStub.getClass().getName()));
