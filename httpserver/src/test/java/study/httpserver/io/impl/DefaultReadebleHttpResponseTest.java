...
public class DefaultReadebleHttpResponseTest {
	...
	public void testSetHeaderString() {
		httpResponse.setHeaders("Test", "value");
	...
	public void testSetHeaderNormalize() {
		...
		httpResponse.setHeaders("TEST-header", "value");
	...
	public void testSetHeaderNameNotNull() {
		...
		httpResponse.setHeaders(null, "value");
	}
	...
	public void testSetHeaderValueNotNull() {
		...
		httpResponse.setHeaders("name", null);
	}

	@Test
	public void testSetHeaderInt() {
		httpResponse.setHeaders("Test", 1);
		assertEquals("1", httpResponse.getHeaders().get("Test"));
	}

	@Test
	public void testSetHeaderDouble() {
		httpResponse.setHeaders("Test", 1.2);
		assertEquals("1.2", httpResponse.getHeaders().get("Test"));
	}

	@Test
	public void testSetHeaderBoolean() {
		httpResponse.setHeaders("Test", true);
		assertEquals("true", httpResponse.getHeaders().get("Test"));
	}

	/*
	 * @Test public void testSetHeaderDate() { long time = 1474736591920L;
	 * httpResponse.setHeaders("Test", new Date(time)); assertEquals(
	 * "Sat, 24 Sep 2016 20:03:11 +0300",
	 * httpResponse.getHeaders().get("Test")); }
	 * 
	 * @Test public void testSetHeaderFileTime() { long time = 1474736591920L;
	 * httpResponse.setHeaders("Test", FileTime.from(time,
	 * TimeUnit.MILLISECONDS)); assertEquals("Sat, 24 Sep 2016 20:03:11 +0300",
	 * httpResponse.getHeaders().get("Test")); }
	 */
	...
	public void testSetBodyInputStreamIoException() throws IOException {
		...
		thrown.expectMessage(new IsEqual<String>("Can't set response body from inputstream: Test"));
	...
	public void testSetBodyReaderIoException() throws IOException {
		...
		thrown.expect(HttpServerException.class);
		thrown.expectCause(new IsSame<Throwable>(cause));
		thrown.expectMessage(new IsEqual<String>("Can't set response body from reader: Test"));
