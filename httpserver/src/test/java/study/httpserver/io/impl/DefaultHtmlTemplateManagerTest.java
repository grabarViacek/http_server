...
public class DefaultHtmlTemplateManagerTest {
	...
	public void testTemplateWithParam() {
		...
		String result = defaultHtmlTemplateManager.processTemplate("test",
				DataUtils.buildMap(new Object[][] { { "PARAM1", "Hello" } }));
	...
	public void testIOException() throws IOException {
		...
		when(defaultHtmlTemplateManager.getClasspathResource("html/templates/io-error"))
